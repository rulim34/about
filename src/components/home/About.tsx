    ...
    <section className="max-w-5xl mx-auto py-14 xs:py-20 md:py-24">
      ...
      <div>
        <p className="mt-10 text-slate-400 text-lg">
          Hi there! I&#39;m{' '}
          {isBusiness
            ? "Muhammad Naufal Khoirul Imamilhaq Alhifdi. Long name, isn't it? Therefore, my mother gave me an alias that you will probably see more often on the internet, Ahmad Rulim"
            : 'Ahmad Rulim'}
          . I&#39;m a technology enthusiast who loves solving problems with code.
        </p>
        ...
        <p className="mt-4 text-slate-400 text-lg">
          ...
          DevOps through courses at{' '}
          <a href="https://www.dicoding.com/users/rulim34/academies" className="link">
            Dicoding Indonesia
          </a>
          .
        </p>
