...
import { Social } from '../core';

type Props = {
  isBusiness?: boolean;
};

export function Hero({ isBusiness }: Props) {
  return (
    <section className="min-h-screen max-w-5xl mx-auto py-24 flex flex-col justify-center items-start">
      ...
      <h2 className="mt-3 text-slate-50 text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl">
        {isBusiness ? 'Muhammad Naufal Khoirul Imamilhaq Alhifdi' : 'Ahmad Rulim'}.
      </h2>
      ...
      <Social className="mt-7" socialMedia={Config.social} />
    </section>
  );
}
